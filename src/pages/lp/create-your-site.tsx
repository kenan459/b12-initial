...
const CreateYourSite = () => (
  <SEMLandingPageLayout>
    <HeroTextImage
      title="Create your site in seconds with B12's website builder"
      ...
      image={
        <>
          <StaticImage
            ...
            alt="Create your site in seconds with B12's website builder"
            width={960}
            loading="eager"
            quality={100}
            placeholder="none"
...
export default CreateYourSite

export const Head = () => (
  <SEO
    pageTitle="Create Your Site for Free"
    pageDescription="Create your site for free with the B12 website builder for professional service providers."
  />
)
